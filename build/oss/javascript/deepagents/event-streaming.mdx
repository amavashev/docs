...
<Note>
Interested in lower-level Pregel stream modes and the existing Deep Agents streaming guide? See the [Pregel Streaming page](/oss/javascript/deepagents/streaming).
</Note>
