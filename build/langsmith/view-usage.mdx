...
| [Evaluator spend](/langsmith/evaluator-spend) | Evaluators page, evaluator detail | All workspace members | Tracked over a rolling 7-day window, separate from the monthly billing period below |
