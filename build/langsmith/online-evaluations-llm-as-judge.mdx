...
You can cap LLM cost on this evaluator's attachment per week. The workspace default applies unless a workspace admin sets a custom value in the **Spend limit** field under the **Advanced** section of the attachment. To remove an override and inherit the workspace default again, click **Reset to workspace default**. When weekly spend reaches the effective limit, LangSmith pauses enqueuing new batches for this attachment, and resumes once spend drops below the limit.
